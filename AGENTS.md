...
| Event Feed connector: the long-lived push+poll transport, hand-written behind its TicketMinter/PollSource seams (SPEC.md §23) | `go/pkg/basecamp/eventfeed/` (Go reference; the other SDKs and the Layer-1 seam adapters over the generated operations are pending) |
