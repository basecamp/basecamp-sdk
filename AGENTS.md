...
All 233 operations across the ~49-service per-SDK layer are generated. Hand-written code is limited to infrastructure:
...
`spec/basecamp.smithy` holds 233 worked operations. Copy the nearest one rather than
