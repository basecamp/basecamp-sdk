...
All 241 operations across the ~50-service per-SDK layer are generated. Hand-written code is limited to infrastructure:
...
`spec/basecamp.smithy` holds 241 worked operations. Copy the nearest one rather than
