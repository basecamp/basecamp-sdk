...
|-----------|--------|---------|
| **Smithy Spec** | 217 operations | Single source of truth for all APIs |
...
All 217 operations across the ~45-service per-SDK layer are generated. Hand-written code is limited to infrastructure:
