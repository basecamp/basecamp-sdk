...
All 231 operations across the ~48-service per-SDK layer are generated. Hand-written code is limited to infrastructure:
...
`spec/basecamp.smithy` holds 231 worked operations. Copy the nearest one rather than
