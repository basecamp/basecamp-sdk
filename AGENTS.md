...
| Event Feed connector: the long-lived push+poll transport, hand-written behind its TicketMinter/PollSource seams (SPEC.md §23) | `go/pkg/basecamp/eventfeed/` (Go reference, foundations only so far — the run loop, the Layer-1 seam adapters over the generated operations, and the other SDKs are all pending) |
...
| Recording summaries and mention helpers (summarize over generated typed reads with Campfire discovery; expandMentions/createWithMentions over generated people read + comment create; SPEC.md §18, Appendix F) | `go/pkg/basecamp/recording_summary.go`, `go/pkg/basecamp/mentions.go`, `go/pkg/basecamp/comments.go`, `typescript/src/services/recordings-extensions.ts`, `typescript/src/services/comments-extensions.ts`, `typescript/src/services/mentions.ts`, `ruby/lib/basecamp/services/recordings_extensions.rb`, `ruby/lib/basecamp/services/comments_extensions.rb`, `ruby/lib/basecamp/mentions.rb`, `ruby/lib/basecamp/campfire_index.rb`, `python/src/basecamp/services/recordings.py`, `python/src/basecamp/services/comments.py`, `python/src/basecamp/mentions.py`, `python/src/basecamp/services/_campfire_index.py`, `kotlin/sdk/src/commonMain/kotlin/com/basecamp/sdk/services/RecordingsService.kt`, `kotlin/sdk/src/commonMain/kotlin/com/basecamp/sdk/services/CommentsService.kt`, `kotlin/sdk/src/commonMain/kotlin/com/basecamp/sdk/Mentions.kt`, `kotlin/sdk/src/commonMain/kotlin/com/basecamp/sdk/services/CampfireIndex.kt`, `swift/Sources/Basecamp/RecordingsServiceExtensions.swift`, `swift/Sources/Basecamp/CommentsServiceExtensions.swift`, `swift/Sources/Basecamp/Mentions.swift`, `swift/Sources/Basecamp/CampfireIndex.swift`, `rust/basecamp-sdk/src/services/recordings.rs`, `rust/basecamp-sdk/src/services/comments.rs`, `rust/basecamp-sdk/src/mentions.rs`, `rust/basecamp-sdk/src/services/campfire_index.rs` |
