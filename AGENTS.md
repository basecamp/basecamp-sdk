...
All 230 operations across the ~47-service per-SDK layer are generated. Hand-written code is limited to infrastructure:
...
`spec/basecamp.smithy` holds 230 worked operations. Copy the nearest one rather than
