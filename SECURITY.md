...
all 238 operations: the 122 GETs are retryable by method, and 77 mutations are flagged
`idempotent: true` — all 47 PUTs, all 23 DELETEs, and 7 POSTs (`CompleteTodo`, `PauseQuestion`,
