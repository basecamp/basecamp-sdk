...
all 235 operations: the 122 GETs are retryable by method, and 75 mutations are flagged
`idempotent: true` — all 47 PUTs, all 22 DELETEs, and 6 POSTs (`CompleteTodo`, `PauseQuestion`,
