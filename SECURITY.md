...
all 233 operations: the 121 GETs are retryable by method, and 74 mutations are flagged
`idempotent: true` — all 46 PUTs, all 22 DELETEs, and 6 POSTs (`CompleteTodo`, `PauseQuestion`,
