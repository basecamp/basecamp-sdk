...
all 241 operations: the 123 GETs are retryable by method, and 79 mutations are flagged
`idempotent: true` — all 48 PUTs, all 24 DELETEs, and 7 POSTs (`CompleteTodo`, `PauseQuestion`,
