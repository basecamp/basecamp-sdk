...
All `267` operations in `behavior-model.json` use `retry_on: [429, 503]`, except `UpdateProjectClientAccess` (`[503]` — its 429 is a seat-limit verdict, §7 Gate 3). <!-- @operation-count --> Three `(max, base_delay_ms)` patterns exist:
...
- "RecordingsSummarize routes comment.created to the comment read and reads its mentions" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize refuses boost.created before any request" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize finds a chat line under the second visible Campfire" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize reports a chat line under no visible Campfire as unresolved, not as a failed read" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize returns a Campfire candidate's 403 as that read's error" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "CommentsCreateWithMentions resolves each person before posting and writes the mention from attachable_sgid" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize routes message.created (event type) to one typed read and projects the recording" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize routes todo.created (event type) to one typed read and projects the recording" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize routes card.created (event type) to one typed read and projects the recording" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize routes Document (recording type) to one typed read and projects the recording" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize routes Upload (recording type) to one typed read and projects the recording" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize routes Schedule::Entry (recording type) to one typed read and projects the recording" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize routes Question (recording type) to one typed read and projects the recording" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize routes Question::Answer (recording type) to one typed read and projects the recording" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize routes Todolist (recording type) to one typed read and projects the recording" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize routes Vault (recording type) to one typed read and projects the recording" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize routes Inbox::Forward (recording type) to one typed read and projects the recording" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize routes Client::Approval (recording type) to one typed read and projects the recording" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize routes Client::Correspondence (recording type) to one typed read and projects the recording" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize routes GoogleDocument (recording type) to one typed read and projects the recording" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize routes CloudFile (recording type) to one typed read and projects the recording" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize routes Kanban::Step (recording type) to one typed read and projects the recording" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize routes Questionnaire (recording type) to one typed read and projects the recording" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize routes Schedule (recording type) to one typed read and projects the recording" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize routes Todoset (recording type) to one typed read and projects the recording" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize routes Message::Board (recording type) to one typed read and projects the recording" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize routes Kanban::Board (recording type) to one typed read and projects the recording" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize routes Kanban::Column (recording type) to one typed read and projects the recording" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize routes Inbox (recording type) to one typed read and projects the recording" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize routes todo.completed (event type) to one typed read and projects the recording" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize routes todo.assignment_changed (event type) to one typed read and projects the recording" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize routes card.completed (event type) to one typed read and projects the recording" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize routes card.assignment_changed (event type) to one typed read and projects the recording" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize routes Comment (recording type) to one typed read and projects the recording" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize routes Message (recording type) to one typed read and projects the recording" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize routes Todo (recording type) to one typed read and projects the recording" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize routes Kanban::Card (recording type) to one typed read and projects the recording" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize routes Chat::Transcript (recording type) to one typed read and projects the recording" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize routes card.moved (event type) to one typed read and projects the recording" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
- "RecordingsSummarize routes Chat::Lines::Text (recording type) through Campfire discovery and projects the line" — unwaivered, tracked work: a Go-first composite recorded in SPEC Appendix F (Recording Summaries and Mention Helpers); the Go runner executes it, this SDK has no port yet, and a port deletes this entry.
...
**Kotlin** (`kotlin/conformance/.../Main.kt` — the entry below comes from the `link-header` tag branch, not from `KOTLIN_SKIPS`, which the port of the Go-first composite emptied):
...
| `templatifications.json` | Templatifying a recording into the library: the synchronous to-do list template create, the asynchronous templatification, its unaddressed-body wire shape, explicitly-false settings, and the completed result (5 cases) | §3, §10, §11 |
...
- Total operations: `267` <!-- @operation-count -->
