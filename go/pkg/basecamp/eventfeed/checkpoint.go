...
// The run-scoped halves of this contract — checkpointKey, loadCheckpoint and
// saveCheckpoint — are methods on the run loop and live in loop.go. This file
// holds only the identity and the seam, both of which stand alone.
