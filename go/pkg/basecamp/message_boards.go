...
func messageBoardFromGenerated(gb generated.MessageBoard) MessageBoard {
	mb := MessageBoard{
		...
		URL:              gb.Url,
		AppURL:           gb.AppUrl,
		BookmarkURL:      deref(gb.BookmarkUrl),
		MessagesCount:    int(deref(gb.MessagesCount)),
		MessagesURL:      deref(gb.MessagesUrl),
		AppMessagesURL:   deref(gb.AppMessagesUrl),
		Position:         int(deref(gb.Position)),
