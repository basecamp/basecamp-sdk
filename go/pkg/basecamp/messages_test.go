...
// Note: unmarshalWithNumbers is provided by test_helpers_test.go
...
// TestMessagesService_CreateVisibleToClients verifies the tri-state
...
func TestMessagesService_CreateVisibleToClients(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			...
			_, err := svc.Create(context.Background(), 200, &CreateMessageRequest{
				Subject:          "Hello",
