...
func TestWebhookPersonFromGenerated_AllFields(t *testing.T) {
	...
	gp := generated.Person{
		...
		AttachableSgid:      ptr("BAh7CEkiCGdpZAY6BkVU--abc123"),
		Name:                "Annie Bryan",
		EmailAddress:        ptr("annie@honcho.com"),
		PersonableType:      ptr("User"),
		Title:               ptr("Central Markets Manager"),
		Bio:                 ptr("Experienced manager"),
		...
		CanManagePeople:     ptr(false),
		CanPing:             ptr(true),
		CanAccessTimesheet:  ptr(false),
