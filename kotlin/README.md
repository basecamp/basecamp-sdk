...
- `55` services covering the complete Basecamp API <!-- @service-count -->
...
The SDK exposes `55` account-scoped services. <!-- @service-count --> The tables below group the common ones; see `com/basecamp/sdk/generated/services/` for the full set.
