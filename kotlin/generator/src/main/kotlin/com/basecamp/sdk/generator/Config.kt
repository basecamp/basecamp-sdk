 ...
 */
val EXTENSIBLE_SERVICES = setOf(
    "Todos", "Todolists", "Cards", "Uploads", "Documents", "Schedules", "Recordings", "Comments",
)
...
val HAND_WRITTEN_SERVICES = mapOf(
    ...
    "Recordings" to "com.basecamp.sdk.services.RecordingsService",
    "Comments" to "com.basecamp.sdk.services.CommentsService",
)
...
val METHOD_NAME_OVERRIDES = mapOf(
    ...
    "GetTemplateLibraryTodolists" to "getLibraryTodolists",
    "GetTemplateLibraryCardTables" to "getLibraryCardTables",
    "CreateTemplateLibraryCardTable" to "createLibraryCardTable",
    "CreateTemplateLibraryTodolist" to "createLibraryTodolist",
    "GetTemplatification" to "getTemplatification",
...
val TYPE_ALIASES = mapOf(
    ...
    "TemplateLibraryTodolists" to "TemplateLibraryTodolists",
    "TemplateLibraryCardTables" to "TemplateLibraryCardTables",
    "Templatification" to "Templatification",
