...
class TodolistsService(client: AccountClient) :
     ...
     * `TodolistsServiceTest.updateRefusesAMalformedDescriptionBeforeWriting`
     * asserts the marker survives this restatement rather than leaving it to be
     * re-derived here. Rebuilding through the public constructor would drop the
     * marker and tell everything downstream this was not a decode failure
     * (#750). Reading `cause is SerializationException` instead would catch
     * more than this GET's decode:
