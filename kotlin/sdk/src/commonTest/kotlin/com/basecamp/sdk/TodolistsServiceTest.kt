...
class TodolistsServiceTest {
     ...
     * failures, which `updateRefusesAMalformedDescriptionBeforeWriting` above
     * asserts is the second of the two. An auth strategy reaches neither, so
     * its exception arrives as itself.
     */
    @Test
