...
class AccountClient:
    ...
    @property
    def drafts(self):
        from basecamp.generated.services.drafts import DraftsService

        return self._service("drafts", lambda: DraftsService(self))

    @property
    def my_notes(self):
        from basecamp.generated.services.my_notes import MyNotesService
    ...
    def calendars(self):
        ...
        return self._service("calendars", lambda: CalendarsService(self))
