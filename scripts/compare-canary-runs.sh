...
validate_rule_path() {
  ...
  # No '-' in segments: '.foo-bar' parses in jq as subtraction ('.foo - bar'),
  # not a key lookup. No current fixture path needs it; keys requiring
  # quoting are a future, deliberate extension of to_jq_path.
