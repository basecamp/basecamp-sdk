...
apply GetTodolistOrGroup @examples([
  {
    ...
    input: { projectId: 12345678, id: 987654 }
  ...
  },
  {
    ...
    input: { projectId: 12345678, id: 111222 }
...
apply TrashRecording @examples([
  {
    ...
    input: { projectId: 12345678, recordingId: 555666 }
  }
])
...
apply UpdateProjectAccess @examples([
  {
    ...
    input: { projectId: 12345678, grant: [111, 222] }
  },
  {
    title: "Revoke access"
    documentation: "Use revoke array to remove users"
    input: { projectId: 12345678, revoke: [333] }
  },
  {
    title: "Invite new users"
    documentation: "Use create array for new users without accounts"
    input: { projectId: 12345678, create: [{ name: "Jane", email_address: "jane@example.com" }] }
  }
])
...
apply UpdateSubscription @examples([
  {
    ...
    input: { projectId: 12345678, recordingId: 987654, subscriptions: [111, 222] }
  },
  {
    title: "Remove subscribers"
    input: { projectId: 12345678, recordingId: 987654, unsubscriptions: [333] }
  }
])
