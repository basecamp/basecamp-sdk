...
// Inboxes (Forwards)
apply GetInbox @tags(["Inboxes"])
apply ListForwards @tags(["Inboxes"])
apply GetForward @tags(["Inboxes"])
apply ListForwardReplies @tags(["Inboxes"])
apply GetForwardReply @tags(["Inboxes"])
apply CreateForwardReply @tags(["Inboxes"])
