...
apply GetSubtask @tags(["Subtasks"])
apply CreateSubtask @tags(["Subtasks"])
apply UpdateSubtask @tags(["Subtasks"])
apply CompleteSubtask @tags(["Subtasks"])
apply UncompleteSubtask @tags(["Subtasks"])
apply RepositionSubtask @tags(["Subtasks"])
apply DeleteSubtask @tags(["Subtasks"])
