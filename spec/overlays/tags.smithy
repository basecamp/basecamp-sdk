...
apply GetTemplateLibraryTodolists @tags(["Automation"])
apply GetTemplateLibraryCardTables @tags(["Automation"])
apply CreateTemplateLibraryTodolist @tags(["Automation"])
apply CreateTemplateLibraryCardTable @tags(["Automation"])
apply CreateTemplatification @tags(["Automation"])
apply GetTemplatification @tags(["Automation"])
