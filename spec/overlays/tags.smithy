...
// Inboxes (Forwards)
apply GetInbox @tags(["Campfire"])
apply ListForwards @tags(["Campfire"])
apply GetForward @tags(["Campfire"])
apply ListForwardReplies @tags(["Campfire"])
apply GetForwardReply @tags(["Campfire"])
apply CreateForwardReply @tags(["Campfire"])

// Kanban (CardTables, Cards, Columns, Steps)
apply GetCardTable @tags(["Kanban"])
apply ListCards @tags(["Kanban"])
apply GetCard @tags(["Kanban"])
apply CreateCard @tags(["Kanban"])
apply UpdateCard @tags(["Kanban"])
apply MoveCard @tags(["Kanban"])
apply GetCardColumn @tags(["Kanban"])
apply CreateCardColumn @tags(["Kanban"])
apply UpdateCardColumn @tags(["Kanban"])
apply MoveCardColumn @tags(["Kanban"])
apply SetCardColumnColor @tags(["Kanban"])
apply EnableCardColumnOnHold @tags(["Kanban"])
apply DisableCardColumnOnHold @tags(["Kanban"])
apply CreateCardStep @tags(["Kanban"])
apply UpdateCardStep @tags(["Kanban"])
apply CompleteCardStep @tags(["Kanban"])
apply UncompleteCardStep @tags(["Kanban"])
apply RepositionCardStep @tags(["Kanban"])
