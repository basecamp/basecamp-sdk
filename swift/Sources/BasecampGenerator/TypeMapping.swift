...
let typeAliases: [String: (name: String, kind: String)] = [
    ...
    "TemplateLibrary": ("TemplateLibrary", "entity"),
    "TemplateLibraryCopy": ("TemplateLibraryCopy", "entity"),
    "TemplateLibraryConfirmationPerson": ("TemplateLibraryConfirmationPerson", "entity"),
