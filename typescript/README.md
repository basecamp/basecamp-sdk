...
**Upgrading to v0.13.0?** Read [MIGRATING.md](../MIGRATING.md#typescript) before you bump the version — TypeScript carries five breaks your compiler will not catch, all of which give no signal at all.
