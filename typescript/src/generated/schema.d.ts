...
export interface paths {
    ...
    "/projects/{projectId}/status/active.json": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        /**
         * @description Restore a project to active status from trash as well as from the archive (returns 204 No Content).
    ...
    "/projects/{projectId}/status/archived.json": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        /**
         * @description Archive a project, removing it from the active project list (returns 204 No Content).
    ...
    "/recordings/{recordingId}/spotlight.json": {
        ...
        put?: never;
        /**
         * @description Put a recording's card in the spotlight area on its project or template home page.
         *     Idempotent: spotlighting an already-spotlighted recording still returns 201.
         */
        post: operations["SpotlightRecording"];
        /**
         * @description Remove a recording from the spotlight area.
         *     Idempotent: removing an absent spotlight also returns 204.
         */
        delete: operations["UnspotlightRecording"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
...
export interface components {
    schemas: {
        ...
        CreateScheduleEntryRequestContent: {
            summary: string;
            /**
             * @description The entry's start, as a bare date ("2026-06-01") for an all-day entry or a
             ...
             */
            starts_at: string;
            /** @description The entry's end. See starts_at for the date-vs-timestamp rule. */
            ends_at: string;
            description?: string;
        ...
        FeedEvent: {
            ...
            recording_id: number;
            created_at: string;
            details?: components["schemas"]["FeedEventDetails"];
        };
        /**
         * @description Type-specific detail members, published for two types today. `boost.created`
         ...
         */
        ProjectLimitErrorResponseContent: {
            error: string;
            message?: string;
        };
        Question: {
        ...
        SpotlightRecordingResponseContent: components["schemas"]["Recording"];
        /**
...
export interface operations {
    ...
    CreateProject: {
        ...
        responses: {
            ...
            /** @description ProjectLimitError 507 response */
            507: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["ProjectLimitErrorResponseContent"];
                };
            };
        };
    };
    ...
    UnarchiveProject: {
        ...
        requestBody?: never;
        responses: {
            /** @description UnarchiveProject 204 response */
            204: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    ArchiveProject: {
        ...
        requestBody?: never;
        responses: {
            /** @description ArchiveProject 204 response */
            204: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    SpotlightRecording: {
        ...
        requestBody?: never;
        responses: {
            /** @description SpotlightRecording 201 response */
            201: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["SpotlightRecordingResponseContent"];
                };
            };
            /** @description UnauthorizedError 401 response */
            401: {
    ...
    UnspotlightRecording: {
        ...
        requestBody?: never;
        responses: {
            /** @description UnspotlightRecording 204 response */
            204: {
                headers: {
                    [name: string]: unknown;
                };
